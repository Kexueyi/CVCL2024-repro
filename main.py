...
def main(args):
    ...
    data = get_dataset(args.dataset, preprocess, args.class_file_path, args.use_attr)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_attr', type=bool, default=False, help='Use attributes or not')
